...
. In API Manager, go to *API Administration* > *{API Name}* > *Policies* > *Add a policy* to xref:gateway::flex-gateway-secure-conn.adoc[apply policies] at the individual API level. 

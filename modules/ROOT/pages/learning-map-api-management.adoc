= API Management on Anypoint Platform: Getting Started

:page-article-style: learning-map

Manage and secure any API across its lifecycle on Anypoint Platform. Accelerate delivery and reduce API sprawl with built-in governance, access control, and monitoring. This learning map guides you through the end-to-end journey to design, discover, manage, govern, and publish APIs.

...
:description: Explore the API management learning map to find guided resources, tutorials, and documentation for managing APIs with MuleSoft Anypoint Platform.
:keywords: api management, learning map, anypoint platform, mulesoft, api lifecycle, tutorials, getting started
...
- xref:gateway::flex-gateway-secure-apis.adoc[Secure and Govern Omni Gateway APIs]
...
- https://www.youtube.com/watch?v=eguO1gO-rss[Product Spotlight: Omni Gateway]
- https://www.youtube.com/watch?v=OUFadXZ0NjQ[Friends of Max Overview: Omni Gateway]
...
* xref:gateway::index.adoc[Omni Gateway]

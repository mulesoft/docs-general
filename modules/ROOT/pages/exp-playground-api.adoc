...
The API playground lets you explore an API's endpoints, configure and send requests, and inspect responses from the service detail page. Instead of copying paths into an external tool such as Postman, you exercise the API in the enhanced experience and see the results next to its documentation.

//placeholder for image of API playground
...
. In *Portfolio*, open the *APIs* catalog and select the API you want to test.

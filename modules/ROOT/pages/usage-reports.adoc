...
Hyperforce, Government Cloud, and Anypoint Private Cloud Edition aren’t available for standalone deployments for Usage Reports.
...
Standalone deployments show both managed and sideloaded applications in the usage reports. Managed applications are deployed using Anypoint Runtime Manager, while sideloaded applications aren't deployed using Anypoint Runtime Manager.


[[usage-reports-on-hyperforce]]
== Usage Reports on Hyperforce
All features of Usage Reports are supported on Hyperforce except for standalone deployments.

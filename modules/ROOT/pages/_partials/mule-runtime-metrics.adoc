:description: Explore Mule Runtime metrics available for monitoring application performance, including JVM, memory, CPU, and threading metrics.
:keywords: mule runtime metrics, performance monitoring, jvm metrics, memory metrics, cpu metrics, threading metrics, mule monitoring
// tag::intro[]

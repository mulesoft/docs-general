...
Standalone deployments show both managed and sideloaded applications on the usage reports. Managed apps are deployed using Anypoint Runtime Manager, while sideloaded apps aren't deployed using Anypoint Runtime Manager.

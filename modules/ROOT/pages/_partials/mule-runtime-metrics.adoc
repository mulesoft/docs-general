...
With standalone deployment, you can deploy your applications from the Runtime Manager cloud console to your Mule servers, and use Runtime Manager to manage them. It's a hybrid deployment option that gives you the best of both worlds: the flexibility of on-premises deployment with the convenience of cloud-based management. For more information, see xref:runtime-manager::deployment-strategies.adoc#hybrid-deployments[Hybrid Deployments] in the Runtime Manager documentation.

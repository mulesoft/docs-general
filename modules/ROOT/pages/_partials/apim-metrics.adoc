:description: Learn how to view and analyze API Manager metrics to monitor API performance, usage trends, and request data across your managed APIs.
:keywords: api manager metrics, anypoint platform, api analytics, api monitoring, api performance, usage metrics, mulesoft api management
// tag::intro[]

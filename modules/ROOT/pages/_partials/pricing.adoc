:description: Explore MuleSoft pricing details, including plans, tiers, and cost information for Anypoint Platform products and services.
:keywords: mulesoft pricing, anypoint platform pricing, mulesoft plans, pricing tiers, subscription costs, mulesoft licensing, platform pricing
...
|mule.2xlarge      | 4                     | 15 GB        | 7.5 GB      | 20 GB
|===
// end::pricingTable[]

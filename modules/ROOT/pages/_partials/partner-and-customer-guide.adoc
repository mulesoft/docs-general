...
+
NOTE: Switching parent POMs for existing connectors may not be straightforward depending on the connector’s complexity. If you need to upgrade with minimal changes, you can continue to use `mule-modules-parent` as described below.

:description: Learn how to view and manage usage reports in MuleSoft, including steps to monitor API calls, transactions, and resource consumption metrics.
:keywords: usage reports, mulesoft usage, api consumption, transaction reports, resource monitoring, usage metrics, anypoint platform reports
...
. In the Anypoint Platform navigation bar, click your username icon and select *Usage Reports*.

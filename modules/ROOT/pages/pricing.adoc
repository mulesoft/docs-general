...
When your organization opts in to the new usage pricing and packaging model, your usage reports temporarily display both vCore-based usage and the new usage metrics for your apps. Your apps must be redeployed after your organization implements the new usage pricing and packaging. Because a usage report covers an entire month, during the month that redeploy happens, usage reports appear for both usage pricing and vCore pricing.

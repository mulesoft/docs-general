...
For Runtime Fabric, you must redeploy apps manually. After you redeploy all Runtime Fabric apps, usage reporting shifts from a mix of usage and vCore reports to all usage-based reporting. You must redeploy Runtime Fabric apps in a timely manner to remain in compliance with your Anypoint Platform contract.

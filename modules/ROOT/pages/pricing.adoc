...
When your organization opts into a usage-based pricing plan, such as the Anypoint Integration Advanced package, your apps must be redeployed. After redeploying your apps, your usage reports temporarily display both legacy vCore-based usage and usage-based metrics for your apps. Usage reports cover an entire month, so usage reports appear for both the usage-based pricing packages and the legacy subscription-based vCore pricing for that month.

...
:description: Explore key terms and definitions used in MuleSoft Anypoint Experience Hub to understand core concepts and terminology.
:keywords: anypoint experience hub, glossary, terminology, definitions, mulesoft concepts, api experience, key terms

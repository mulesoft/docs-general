...
When a product version is no longer supported, including products with end-of-life status, its documentation moves to an http://archive.docs.mulesoft.com/[archive site^].

...
:description: Explore MuleSoft documentation to learn how to design, build, and manage APIs and integrations using Anypoint Platform.
:keywords: mulesoft, anypoint platform, api integration, mule runtime, documentation, getting started, integration platform
...
// Updated 2026/06/17 - sathya
* xref:general::use-mulesoft-docs-with-ai.adoc[]

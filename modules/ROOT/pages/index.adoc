...
The APIs you build in Anypoint Platform to integrate applications and services are reusable and built with enterprise-level security.
...
Anypoint Studio is an Eclipse-based IDE that enables you to create integrations. Design Center, a web-based tool, enables you to create API specifications, which are the foundation for data integrations.
...
Anypoint Studio 7.0 and later includes xref:mule-runtime::index.adoc[Mule Runtime (Mule) 4], the runtime environment where you deploy Mule apps and APIs.
...
After you test your integration, you can deploy them into a production environment:
...
After your integration is running in production, you can monitor its performance:
...
During the development cycle, or after deployment, you can make changes to your integration:
...
When an earlier version of a product is no longer supported, including products with end-of-life status, the documentation moves to an https://docs.archive.mulesoft.com/[archive site^].

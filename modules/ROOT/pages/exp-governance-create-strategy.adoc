...
For Controls strategies, the flow also includes a *Notifications* step between *What to Apply* and *Name & Description*. This step does not appear for Automated Policy strategies.

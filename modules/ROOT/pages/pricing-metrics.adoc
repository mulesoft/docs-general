...
Runtime Manager, Anypoint MQ, and Object Store store some usage data, such as vCore allocations and API requests, in Access Management.
...
xref:object-store::osv2-usage.adoc#access-object-store-effective-api-request-usage-charts[Object Store metrics] in Access Management include API requests.

To access Object Store metrics:

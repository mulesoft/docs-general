...
Your *Portfolio* is organized into catalogs—*Agents*, *APIs*, *MCP Servers*, *LLM Proxies*, and *Gateways*. Each catalog holds the services (or gateway entries) your organization registered or imported so you can govern, monitor, and deploy them from one place.
...
|xref:omni-connecting-providers-to-add-services.adoc[Connect to providers]
...
|xref:omni-registering-services-manually.adoc[Register manually]
...
For step-by-step instructions for any of these types, see xref:omni-registering-services-manually.adoc[Registering Services Manually] and xref:omni-connecting-providers-to-add-services.adoc[Connecting to Providers to Add Services].

Scanners and manual flows can differ by entitlement and release; if a path is missing in your UI, confirm with your administrator.

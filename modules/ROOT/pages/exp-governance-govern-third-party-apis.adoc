...
. Use the xref:exp-governance-setup-third-party-providers.adoc[provider connection wizard] to connect to your third-party API gateway. The system creates a scanner and begins discovering APIs.

. Go to *Portfolio* > *APIs* and verify that discovered APIs appear with the provider name in the *Provider* column. APIs are automatically added to the portfolio as they are discovered.

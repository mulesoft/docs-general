...
. On the *Overview* tab, review *Sync Activity*.
+
A health check confirms that MuleSoft can still reach the vault. Those runs don't add, remove, or update secrets. A metadata sync records secrets that are added, removed, or updated.
...
. On the *Secrets* tab, review the secret names and paths that MuleSoft discovered.
+
...
To change credentials or delete the vault, use the *Settings* tab. See <<edit-or-delete-a-vault>>.

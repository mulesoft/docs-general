= Java Support
:description: Learn how DataWeave supports Java types, enabling you to read, write, and transform Java objects within Mule applications.
:keywords: dataweave java support, java types, mule java integration, dataweave java module, java objects, type mapping, mule applications

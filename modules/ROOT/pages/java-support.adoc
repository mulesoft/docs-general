...
. Conduct an analysis of your current setup to pinpoint compatibility issues or deprecated elements.
...
.. Upgrade all <<anypoint-connectors-and-modules, Anypoint Connectors and modules>>, and <<custom-connectors, custom connectors>> used within Mule apps and policies to Java 17.
.. Upgrade your <<policies, policies>>.
.. Upgrade your <<api-proxies, API proxies>> and <<mule-apps, Mule apps>>.

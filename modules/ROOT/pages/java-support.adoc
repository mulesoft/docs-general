...
* If your workloads are running on-premises, such as in a hybrid or standalone environment, you must tune your operating system’s garbage collection algorithm. 

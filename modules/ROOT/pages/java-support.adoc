...
When you deploy an app to CloudHub, Runtime Manager proactively detects mismatches between the project's Java version and the deployment environment. For example, if your project is built for Java 8 and your target environment is a Java 17 environment, Runtime Manager provides guidance to prevent deployment failures.

...
As of May 8, 2024, MuleSoft Government Cloud supports Java 17, so connectors that are compatible with Java 17 are now available in MuleSoft Government Cloud. 

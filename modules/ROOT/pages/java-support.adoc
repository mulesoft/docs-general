...
[NOTE]
Along with the end of standard support for Java 8 and 11 with the Mule runtime 4.9 release in February 2025. Plan your upgrade path for apps that are running on either Java 8 or Java 11.

...
* If your workloads are running on Runtime Fabric, you must allocate 1400 MB of memory for 0.50 vCPU replica sizes. Memory requirements vary for individual apps. This is the minimum recommended size as the best configuration for memory allocation for most applications.

...
== Upgrading API Policies and Proxies
...
[IMPORTANT]
To ensure your API proxies or Mule apps are protected when upgrading, upgrade your policies first before upgrading your API proxies or Mule apps.

See xref:upgrade-policies-proxies.adoc[Upgrade Java for API Policies and Proxies]

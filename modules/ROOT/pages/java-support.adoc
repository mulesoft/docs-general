= Java Support
:description: Learn how MuleSoft supports Java in your integrations, including supported versions, configuration, and best practices for using Java components.
:keywords: java support, mulesoft java, java integration, java components, java version compatibility, mule java, java configuration

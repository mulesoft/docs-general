= Upgrade Java for Custom Connectors (Customers)
...
include::general::partial$partner-connector-upgrade.adoc[tags=before-you-begin]
...
include::general::partial$partner-connector-upgrade.adoc[tags=mule-sdk-connectors]

include::general::partial$partner-connector-upgrade.adoc[tags=rest-connect-connectors]

...
include::partial$partner-connector-upgrade.adoc[tags=before-you-begin]
...
include::partial$partner-connector-upgrade.adoc[tags=mule-sdk-connectors]

include::partial$partner-connector-upgrade.adoc[tags=rest-connect-connectors]

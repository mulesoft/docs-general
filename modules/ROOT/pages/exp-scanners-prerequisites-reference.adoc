...
*Permissions:* Metadata read access to the catalog—data services, classifications, business glossary terms, and quality scores. A dedicated service account with read-only catalog access is recommended.

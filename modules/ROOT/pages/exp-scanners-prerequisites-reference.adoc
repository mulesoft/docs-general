...
* *OAuth 2.0 Authorization Code:* Interactive sign-in and consent in a Microsoft popup. Tenant ID is optional; if you don't provide one, the connection defaults to the home tenant ID after authorization.
* *Client Credentials:* Tenant ID is required.

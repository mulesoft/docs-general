...
:description: Learn how to create, configure, and manage governance strategies to enforce API standards and compliance policies across your organization.
:keywords: governance strategies, api governance, manage strategies, anypoint platform, api standards, compliance policies, governance rules

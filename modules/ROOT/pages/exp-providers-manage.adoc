...
In list and card views, the numeric *Security Risk* value is the raw Akamai risk score, and the color-coded label (Low, Medium, High, or Critical) is the severity band derived from that score.

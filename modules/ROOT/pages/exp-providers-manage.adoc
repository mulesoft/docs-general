...
+
For Akamai API Security scanners, the overview reflects correlation and security enrichment activity for existing services. Akamai scanners do not import new services.

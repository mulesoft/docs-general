...
To see detailed information about a scanner, including scan history and settings, select the scanner name in the scanner list. The scanner detail page opens with three tabs:
...
Services::
Lists all services discovered by this scanner, organized by type: Agents, APIs, MCP Servers, and LLM Proxies.

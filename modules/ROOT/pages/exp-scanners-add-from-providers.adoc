...
:description: Learn how to add scanners from external providers to analyze and detect issues in your APIs and integrations using MuleSoft tools.
:keywords: scanners, providers, add scanners, api security, mulesoft exchange, vulnerability scanning, integration tools, external providers

...
*** *Service Account Email*: Email of the service account with the *Vertex AI Viewer* role. Required for *Service Account Key*.
*** *Private Key*: Private key from the service account key file. Required for *Service Account Key*.

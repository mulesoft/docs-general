...
When you scan with the *Kong Gateway (APIs)* platform, the scanner assigns an asset type to each discovered service based on the service's Kong protocol and plugins.

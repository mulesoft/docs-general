...
:description: Learn how to upgrade partner connectors in MuleSoft, including step-by-step migration guidance, compatibility requirements, and best practices.
:keywords: partner connector upgrade, mulesoft connector migration, connector upgrade guide, anypoint connector, mule 4 connector, connector compatibility, partner integration upgrade
...
include::partial$partner-and-customer-guide.adoc[tags=custom-configuration-properties-provider-partners]

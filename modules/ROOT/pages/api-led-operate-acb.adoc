...
* *Mule Messages*
+
The number of Mule messages the application has processed.
+
Send a few test requests from Postman and watch the *Mule Messages* graph update.
...
You used Runtime Manager to check your application's health metrics, view live logs including the Logger messages from your flow, and verify the deployed API responds correctly from anywhere.

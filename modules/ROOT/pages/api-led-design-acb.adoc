...
* *Option A: Use MuleSoft Vibes (AI-Powered)* - If you have the Mule Developer Generative AI User permission and Agentforce enabled
* *Option B: Create Manually* - If you don't have access to MuleSoft Vibes
...
. In the *API Specification* dialog:
.. For *Project Name*, enter `hello-world-api`.
.. For *Project Location*, select your home directory.
.. For *API Specification Language*, select *OAS 3.0 (YAML)*.
...
The file is now open in the editor. Regardless of which method you used, you now have a complete API specification. Let's review the structure:
+
[source,yaml]
----
openapi: 3.0.0

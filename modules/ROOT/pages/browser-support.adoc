...
:description: Learn which web browsers are supported for MuleSoft tools and platforms, including recommended versions and compatibility requirements.
:keywords: browser support, supported browsers, browser compatibility, web browser requirements, mulesoft platform, browser versions, compatibility matrix
...
https://help.salesforce.com/s/articleView?language=en_US&id=getstart_browsers_sfx.htm&type=5[Supported Browsers for Lightning Experience^]

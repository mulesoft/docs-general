...
.. *Consumer Endpoint*: The URL where the Model Proxy will be accessible.
.. *Port*: The port number for the Model Proxy (for example: `8081`).
. Click *Continue*.
...
*** *Destination URL*: The URL for your provider endpoint. Ensure the URL is correct and edit if necessary.

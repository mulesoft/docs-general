...
. Deploy an Omni Gateway version 1.11.4 or later where you want to deploy your Model Proxy.
+
...
. xref:model-proxy-semantic-service.adoc[Configure a semantic service] if you want to use semantic routing.

[[create-a-model-proxy]]
== Create an Model Proxy
...
== Edit and Delete an Model Proxy

To edit an Model Proxy:

...
:keywords: api-led connectivity, anypoint code builder, cloudhub 2.0, prerequisites, mulesoft setup, api-led solution, installation
...
+
*MuleSoft Vibes* requires generative AI to be enabled in Access Management. See xref:access-management::enabling-generative-ai.adoc[].

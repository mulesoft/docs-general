...
To automatically cap usage, configure budgets in the *budgets* tab or through model wallets. Budgets block requests once the limit is reached. You can also apply governance strategies or rate-limiting policies.

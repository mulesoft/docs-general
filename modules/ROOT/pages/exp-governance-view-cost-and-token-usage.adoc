...
Watch this video to see how to track cost and token usage:

++++
include::_partials/exp-governance-view-cost-and-token-usage-video.html[]
++++
...
. Use the *Tokens*/*Cost* toggle to choose how metrics display. See <<view-metrics-in-tokens-or-cost>>.

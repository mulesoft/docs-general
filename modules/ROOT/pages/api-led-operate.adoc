...
:description: Learn how to operate and monitor APIs in an API-led connectivity architecture using MuleSoft Anypoint Platform tools and best practices.
:keywords: api-led connectivity, operate apis, anypoint platform, api monitoring, api management, mulesoft operations, runtime manager

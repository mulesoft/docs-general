...
. *Configure the scanner in MuleSoft.* Add an Akamai scanner and enter the Akamai service account credentials (client ID and clientsecret) and the Akamai base URL, along with a scan frequency. See <<Set Up the Akamai Scanner>>.

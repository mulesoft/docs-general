...
:description: Learn how to design APIs using the API-led connectivity approach in MuleSoft, structuring integrations across experience, process, and system layers.
:keywords: api-led connectivity, api design, experience api, process api, system api, mulesoft integration, anypoint platform
...
Youâll see some of the most popular API specifications, connectors, and other assets displayed on the landing page.
+
...
* In addition to the public Exchange, you can review your own organizationâs internal offerings.
+
...
In a typical API project, youâd likely want to do a few more things:

...
//Now that you've protected your API from a denial-of-service attack, let's set up some monitoring.
//
// === Step 5.6: Set API Monitoring Alerts
//
// === Step 5.7: Configure the application and infrastructure for deployment
//
// === Step 5.8: Deploy an application version
//
// === Step 5.9: Sanity test the deployment
//
// === Step 5.10: Update portal with implementation URL
...
MuleSoft provides many deployment options:

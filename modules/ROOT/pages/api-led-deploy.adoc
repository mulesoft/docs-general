...
. Open Runtime Manager and log in if you aren't already.
+
...
+
image:runtime-mgr2.png

  .. Copy the *Domain* value: `hello-world-greeting.us-e2.cloudhub.io` or similar. This is the base URI.
...
[source, xml]
---- 
GET http://hello-world-greeting.us-e2.cloudhub.io/greeting
----

...
* Publish OAS 3.0 API specifications to Anypoint Community Manager.
* Share OAS 3.0 API specifications as RAML specifications with Anypoint Studio and API Manager.
+
...
[NOTE]
====
If you want to share an OAS 3.0 API specification in OAS 2, download your OAS 3.0 specification as-is, and then convert it to OAS 2 by using a tool such as APIMatic transformer.
====
...
[NOTE]
====
If you want to share an OAS 3.0 specification in OAS 2, download your OAS 3.0 specification as-is, and then convert it to OAS 2 by using a tool such as APIMatic transformer.
====

...
image:canvas-tabs.png[One canvas and links to all three views]
...
+
image:greeting-module.png[View of GET connector as created by scaffolding]
...
+
image:set-payload.png[View of canvas and configuration dialog for Set Payload connector]
...
+
image:link-to-published-api.png[Dialog showing link to API published in Exchange]

...
You are going to deploy first to Mule in Studio, then, when the app is complete, you'll deploy it to Mule in CloudHub.
...
+
This ensures that Studio adds default error handling and other helpful items to your project
...
If you scroll down the canvas, you can see all the scaffolding that has been added to your app:
...
* *Message Flow* makes it easy to drag and drop modules, connectors, and other assets and create the relationships between them.
* *Global Elements* makes it easy to specify global elements used in multiple projects.
* *Configuration XML* makes it easy to edit the XML of a project directly.
...
. Click *Message Flow* to return to the canvas. General configuration values for Listener should still be displayed.

...
* *Message Flow* makes it easy to drag modules, connectors, and other assets and create the relationships between them.
...
. Click *Message Flow* to return to the canvas. The general configuration values for the Listener component are still displayed.

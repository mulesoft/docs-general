...
In Anypoint Platform, developers package an API in an application that is deployed to Mule runtime engine (Mule)
...
Mule is a lightweight integration engine that runs Mule apps.

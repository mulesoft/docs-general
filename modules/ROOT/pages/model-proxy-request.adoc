...
Model Proxy supports both OpenAI and Gemini Responses and Chat Completions requests. To learn more about the these OpenAI request types, see:
...
+
NOTE: Adding a model to a request ensures deterministic routing to a preferred backend if the routing strategy of an Model Proxy changes.

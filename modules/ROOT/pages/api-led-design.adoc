...
+
  ...
  .. Click on any specification to see the data types and the HTTP requests defined for the API. If this is a trial org, you may not see anything yet.
...
To do this, we'll use xref:design-center::design-create-publish-api-specs.adoc[API Designer], a part of xref:design-center::index.adoc[Design Center].
...
+
image:new-api-spec.png[Blank API specification in API Designer]
...
+
image:api-spec1.png[Completed specification, 150]
+
. Click the X next to *Mocking service* to enable it. 
+
image:mocking-service.png[Enabled mocking service]
+
...
+
image:enabled-service.png[Mocking service control before being disabled]
...
+
image:publish-to-exchange1.png[User interface for publishing to Exchange]

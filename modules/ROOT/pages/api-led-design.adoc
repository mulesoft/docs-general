...
Design your API specification before building the implementation. An API specification defines the endpoints, parameters, and responses your API supports, giving you and your team a contract to work from. 
...
After you define the scope and flow of your integration project, define an API specification in OAS. You can use MuleSoft Vibes to generate the spec from a plain-language description, or create it manually in Anypoint Code Builder.
...
After exploring Exchange to see the range of assets available, use Anypoint Code Builder to create a new API specification.
...
. Go to <<step-2-4,Step 2.4: Review Your API Specification>>.
--
...
+
image:api-tutorial-create-project-acb.png[The form to create a new API specification with values filled in]
...
You now have a complete API specification open in the editor. Review the structure:

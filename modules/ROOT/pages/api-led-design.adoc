...
define an API specification in xref:http://https://raml.org/[RAML] or xref:https://openautomationsoftware.com/[OAS].
...
To do this, we'll use xref:design-create-publish-api-specs.adoc[API Designer], a part of xref:design-center::index.adoc[Design Center].

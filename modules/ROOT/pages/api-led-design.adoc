...
. Click *Try it*.
. Click *Send* to send your request to the temporary request URL that the mocking service creates from your specification. If the request is successful, you’ll see *HTTP message 200 OK* and the sample message defined in the API specification. 

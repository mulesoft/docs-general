...
+
image:api-tutorial-open-api-console-acb.png[alt="API Console icon highlighted in toolbar while YAML file is open in Anypoint Code Builder API design editor"]
+

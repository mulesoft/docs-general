...
. Click *New API Specification*.
. In *Project name*, enter `hello-world` and don't change the other default values.
...
. Accept all the default values, click *Publish to Exchange*. 

...
:description: Learn how to design APIs using an API-led connectivity approach to create reusable, discoverable, and scalable integrations in MuleSoft Anypoint Platform.
:keywords: api-led design, api-led connectivity, anypoint platform, api design, mulesoft integration, reusable apis, system apis, experience apis
:page-pagination:
...
. With `hello-world-api.yaml` still open, click image:icon-api-console.png["",14,14] (*API Console*) in the editor toolbar.
+

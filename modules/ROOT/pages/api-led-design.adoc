...
+
* To see only the items in your organization (account), log in to Anypoint Platform, and then click the buttom under *Exchange*. Logging in changes the view to your organization's private Exchange.
+

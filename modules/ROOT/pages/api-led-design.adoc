...
:description: Learn how to design APIs using the API-led connectivity approach, defining reusable layers to build scalable and flexible integrations in MuleSoft.
:keywords: api-led design, api-led connectivity, mulesoft api design, api layers, system api, process api, experience api
:page-pagination:
...
Youâll see some of the most popular API specs, connectors, and other assets displayed on the landing page.
+

...
Creating instances uses Anypoint Platform permissions such as API Creator for API-related flows. Viewing or editing instance configuration requires the corresponding permissions defined by your organization. See xref:exp-home-start.adoc#permissions[Enhanced Experience Permissions] for role details.

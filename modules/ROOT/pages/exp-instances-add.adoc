...
:description: Learn how to add and configure experience instances in MuleSoft, enabling you to deploy and manage API experiences for your organization.
:keywords: experience instances, add experience instance, api experience hub, mulesoft experience, instance configuration, deploy experience, api management
...
+
--
* *Managed Instance* â Creates a new instance on an Omni Gateway with full support for authentication, monitoring, and policy enforcement.
* *Unmanaged Target* â Creates a basic record of an API endpoint. You can add management for this endpoint later.
--
. Complete the *Instance* fields:
+
--
** *Environment* â Select the environment where the instance runs, such as Sandbox or Production.
** *Omni Gateway* â Select the gateway to route traffic through. Required for managed instances.
** *Version* â Select the API version for this instance.
** *Label* â Optional label to identify the instance.
--

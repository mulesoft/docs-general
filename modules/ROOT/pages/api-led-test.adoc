...
. Click image:icon-plus.png["",15,15] (*Add component*) before the *Logger* component (at the start of the flow).
...
. Click image:icon-plus.png["",15,15] (*Add component*) inside the *When* branch.

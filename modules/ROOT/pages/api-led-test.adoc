...
. Click the curved yellow arrow again, and notice that an error message you defined is now in the *error* object in the debugger pane, and a red dotted-line shows in the Validate size connector.
+
...
. Right-click in the canvas and select *Debug project hello-world*.

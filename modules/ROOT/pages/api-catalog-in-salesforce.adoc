...
. Click *Sync APIs*.
+ 
The sync imports APIs that have the tag of `sf-api-catalog` in Anypoint Exchange and a running instance in API Manager into API Catalog.
...
. In the Operations tab, click *Edit* to modify the operation selection‌s.

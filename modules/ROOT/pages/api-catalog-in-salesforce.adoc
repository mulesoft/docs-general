...
* An Anypoint Platform and Salesforce org connection is established and the API Catalog feature is enabled in Anypoint Platform Access Management. See xref:access-management::connecting-salesforce-orgs.adoc[].

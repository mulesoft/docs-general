...
Work with an Anypoint Platform admin to ensure that they complete all prerequisite configuration in the Anypoint Platform organization so that you can sync APIs. Admins must complete the following before you can begin using API Catalog in Salesforce: 

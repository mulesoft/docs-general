...
* **Existing tool compatibility**: Integrates with MuleSoft and other API management platforms without rebuilding existing assets.
...
=== Example: Limiting Agent Access to Read Operations

...
To get these permissions, use one of these predefined Apigee roles:
...
At launch, Anypoint supports five universal use cases. Each maps to a native policy on each provider. These native policies are exactly the ones you can create and edit. All other recognized policies are view-only.

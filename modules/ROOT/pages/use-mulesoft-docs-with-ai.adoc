...
| Your MCP-compatible client (such as Claude, Cursor, or VS Code) accesses documentation on demand without leaving your IDE or chat window, with no files or infrastructure to manage.

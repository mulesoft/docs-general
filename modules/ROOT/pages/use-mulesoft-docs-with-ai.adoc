...
| You want documentation on demand without leaving your IDE or chat window. Your MCP-compatible client (such as Claude, Cursor, or VS Code) accesses it for you, with no files or infrastructure to manage.

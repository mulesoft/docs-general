...
image::ai-context-menu.png["Documentation page with a dropdown menu showing options: Copy page link, Copy page as Markdown, Copy page as plain text, and Copy page content as HTML"]

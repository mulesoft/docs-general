...
| API Document: The main API specification description metadata, which is the entry point for the specification. | RAML root document | OAS root document | Generates a simple connector.

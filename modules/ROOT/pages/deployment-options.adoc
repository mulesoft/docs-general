...
Anypoint Platform provides multiple deployment options, each of which differs based on data hosting requirements and the location and management of Anypoint Platform functionality: 
...
== Anypoint Platform Functionality Location and Management
To understand the options for Anypoint Platform functionality location and management, it's important to understand that Anypoint Platform functionality can be classified into two main categories:
...
+
Anypoint Platform runtime plane functionality includes the runtime engine (Mule) and runtime services, such as Anypoint Connectors, Anypoint Object Store, and messaging that allow you to scale the power of Mule and Anypoint Platform, and is where applications are deployed.
...
The following table compares Anypoint Platform functionality configuration options:

...
The needs of your organization determine where Anypoint Platform control plane and runtime plane functionality is deployed: on-premises, in the cloud, or in a hybrid environment, and also determine who manages and maintains it. Anypoint Platform control and runtime plane functionality location and management options include:
...
The following location and management options are available for Anypoint Platform control and runtime plane functionality:
...
Each Anypoint Platform deployment supports a different set of individual Anypoint Platform components, but the actual components in your deployment depends on your Anypoint Platform subscription. Refer to https://www.mulesoft.com/anypoint-pricing for detailed Anypoint Platform subscription information.
...
The individual Anypoint Platform runtime plane components in your deployment is based on the runtime plane option in your environment:
...
The following table summarizes Anypoint Platform runtime plane option availability across deployment options:

...
Anypoint Platform provides multiple deployment options, each of which differs based on data hosting requirements and the location and management of Anypoint Platform: 

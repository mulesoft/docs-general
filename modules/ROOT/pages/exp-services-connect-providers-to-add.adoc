...
You can start the flow from *Home* or from a specific catalog in *Portfolio*. To see how this relates to manual registration, see xref:exp-services-add-to-portfolio.adoc[]. For creating and tuning scanners themselves, see xref:exp-scanners-add-from-providers.adoc[].

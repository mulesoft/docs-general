...
Across *Home* and *Portfolio* entry points, creating a scanner includes the same decisions:
...
The scanner setup decisions stay the same across catalogs. What changes is the service catalog where discovered results appear after a successful run.

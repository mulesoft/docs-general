= Create a Scanner to Add Provider Services
...
Scanner setup decisions stay the same across catalogs. However, after successful runs, discovered results get registered in specific service catalogs. For example, when you start from *APIs*, discovered APIs are registered in the *APIs* catalog.

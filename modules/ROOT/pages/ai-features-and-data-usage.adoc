...
:description: Learn how MuleSoft AI features work, what data they collect and process, and how to manage data usage and privacy settings for AI-powered functionality.
:keywords: ai features, data usage, mulesoft ai, data privacy, ai data collection, anypoint platform ai, data management

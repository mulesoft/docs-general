...
:description: Learn how MuleSoft AI features work, what data they collect, and how your data is processed and protected when using AI-powered capabilities.
:keywords: ai features, data usage, mulesoft ai, data privacy, ai capabilities, data processing, anypoint platform ai

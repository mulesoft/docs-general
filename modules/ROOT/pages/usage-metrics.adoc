...
This table defines usage metrics by product and explains how each metric is calculated for reporting.
...
For vCore-specific usage interpretation, including CloudHub vCore peak rollups, see xref:vcore-pricing-usage-and-rates.adoc[].

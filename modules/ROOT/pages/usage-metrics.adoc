...
| These tokens are the sum of all prompt tokens a specific LLM Proxy sends to a specific LLM Model during a month. A prompt sent to an LLM Proxy are considered a Flex Gateway API call and count towards the Flex Gateway API call metric.

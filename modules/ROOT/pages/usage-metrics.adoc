...
API Experience Hub usage reports show the following information in tables and cards:
...
API Governance usage reports show the following information in tables and cards:

include::partial$api-governance-metrics.adoc[tag=table]

== API Manager Usage

API Manager usage reports show the following information in tables and cards:

include::partial$apim-metrics.adoc[tag=table]

== Flex Gateway Usage

Flex Gateway usage reports show the following information in tables and cards:
...
IDP usage reports show the following information in tables and cards:
...
Mule Runtime usage reports show the following information in tables and cards:

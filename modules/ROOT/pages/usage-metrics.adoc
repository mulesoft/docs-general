...
| Integration Starter, Integration Advanced, API Management
| Mule Flows, Mule Messages, Data Throughput, API Calls for Omni/Flex Gateway, API Manager Pre-Production, API Manager Production, APIs Under Governance, Anypoint MQ API request, Object Store API request
|===

== Usage Type Description

The following table defines usage metrics by product and explains how each metric is calculated for reporting.

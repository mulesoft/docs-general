...
| CPU Limit 
| The maximum amount of CPU the application can use. This is shared CPU on the worker node.
| CPU Reserve (Millicores) 
| The amount of CPU guaranteed to the application and reserved for its use.

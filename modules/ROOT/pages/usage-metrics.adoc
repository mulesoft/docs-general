...
include::partial$mule-runtime-metrics.adoc[tag=flows,leveloffset=+3] 
...
include::partial$mule-runtime-metrics.adoc[tag=muleMessages,leveloffset=+3] 

include::partial$mule-runtime-metrics.adoc[tag=dataThroughput,leveloffset=+3] 

...
In the dashboard, compare cores and flows consumed by each application to help you understand your usage and associated pricing. Export the usage report to a CSV file to visualize cores and flows consumed by each app and drill down per environment ID and business group.

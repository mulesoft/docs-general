...
== Anypoint Pricing Plans

The available usage types depend on your Anypoint pricing plan.

[%header%autowidth.spread]
|===
| Available Usage Types | Subscription Plan

.3+|Mule Flows, Mule Messages, Data Throughput, API Calls for Flex Gateway, API Manager Pre-Production, API Manager Production, and APIs Under Governance	

...
| vCore Min
| For CloudHub 2.0 applications with HPA enabled, the guaranteed base vCore allocation based on the minimum replica configuration. For applications without HPA (CloudHub and CloudHub 2.0 non-HPA apps), vCore Min equals vCore Peak.
|===

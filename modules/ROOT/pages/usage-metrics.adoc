...
:description: Learn how to view and interpret usage metrics in MuleSoft to monitor API calls, resource consumption, and platform activity across your organization.
:keywords: usage metrics, mulesoft monitoring, api calls, resource consumption, platform analytics, usage tracking, mulesoft analytics

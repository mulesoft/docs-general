...
include::partial$api-gov-concepts.adoc[tag=api-entire,leveloffset=+2]

// Definition of API Aspects

include::partial$api-gov-concepts.adoc[tag=api-aspects,leveloffset=+2]

// Definition of API Catalog Information

include::partial$api-gov-concepts.adoc[tag=api-catalog-info,leveloffset=+3]

// Definition of API Conformance

include::partial$api-gov-concepts.adoc[tag=api-conformance,leveloffset=+2]

// Definition of API Conformance Status

include::partial$api-gov-concepts.adoc[tag=api-conformance-status,leveloffset=+2]

// Definition of API Documentation

include::partial$api-gov-concepts.adoc[tag=api-documentation,leveloffset=+3]

// Definition of API Governance Usage Reports

include::partial$api-gov-concepts.adoc[tag=api-governance-usage-reports,leveloffset=+2]

// Definition of API Implementation

include::partial$api-gov-concepts.adoc[tag=api-implementation,leveloffset=+3]

// Definition of API Instances

include::partial$api-gov-concepts.adoc[tag=api-instances,leveloffset=+3]

// Definition of API Specifications

include::partial$api-gov-concepts.adoc[tag=api-specifications,leveloffset=+3]

API Governance::
Part of Anypoint Platform that enables you to apply governance rules to your APIs as part of the API lifecycle.
...
include::partial$api-gov-concepts.adoc[tag=governed-apis,leveloffset=+2]

// Definition of Governance Profiles

include::partial$api-gov-concepts.adoc[tag=governance-profiles,leveloffset=+2]

// Definition of Governance Profile Status

include::partial$api-gov-concepts.adoc[tag=governance-profile-status,leveloffset=+2]

// Definition of Governance Rulesets

include::partial$api-gov-concepts.adoc[tag=governance-rulesets,leveloffset=+2]

// Definition of Governance Status

include::partial$api-gov-concepts.adoc[tag=governance-status,leveloffset=+2]
...
include::partial$api-gov-concepts.adoc[tag=nonconformance-severity,leveloffset=+2]
...
include::partial$api-gov-concepts.adoc[tag=project-errors,leveloffset=+2]

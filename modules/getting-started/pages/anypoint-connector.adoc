...
After learning some of the basic functionality in the xref:mule-runtime::mule-app-tutorial.adoc[Mule app tutorial], enrich your application with an *Anypoint Connector*.

...
. xref:design-center::design-create-publish-api-raml-editor.adoc[Design a RAML API Specification].
. xref:design-center::design-mocking-service.adoc[Simulate Calling a RAML API].
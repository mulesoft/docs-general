...
The documentation for Mule application development requires some familiarity with xref:studio::index.adoc[Anypoint Studio]. Make sure you have it installed and get acquainted with it using the xref:studio::basic-studio-tutorial.adoc[Basic Studio Tutorial].

[NOTE]
Install the xref:tudio::setting-up-your-development-environment.adoc[Anypoint Studio hardware and software requirements]. Browse xref:exchange::index.adoc[Anypoint Exchange] to get resources or examples for the integration you want. You can access Exchange from the browser or within Anypoint Studio to retrieve any MuleSoft and partner-supported connectors to help you integrate SaaS applications like ServiceNow and Salesforce, or generic data structures like databases, files and object stores.
...
Dive into more strategies to control how your Mule applications are run and managed starting from the xref:mule-runtime::mule-standalone.adoc[Installing and Deploying] documentation for Mule runtime.
